...
inline constexpr std::size_t STANDARD_HAND_SIZE            = 5;
inline constexpr std::size_t STANDARD_HOLE_CARDS_SIZE      = 2;
inline constexpr std::size_t STANDARD_COMMUNITY_CARDS_SIZE = 5;
